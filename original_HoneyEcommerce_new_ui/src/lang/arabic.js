let arabic = {
  ...
  naturally_delivered_title: "تسليم بعناية",
  naturally_delivered_description: "إكسسوارات منزلية وديكورات مختارة لكل مساحة",
  secure_payments_title: "المدفوعات الآمنة",
  secure_payments_description: "محمية بالكامل عند الدفع عبر الإنترنت",
  footer_logo_alt_text: "غوزو هوم",
  facebook: "فيسبوك",
  twitter: "تويتر",
  youtube: "يوتيوب",
  instagram: "انستجرام",
