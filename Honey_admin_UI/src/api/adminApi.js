...
export const authApi = {
  ...
  me: () => apiRequest(() => client.get('/auth/me')),
}

export const dashboardApi = {
  get: () => apiRequest(() => client.get('/dashboard')),
}

export const usersApi = {
  list: (params) => apiRequest(() => client.get('/users', q(params))),
  get: (id) => apiRequest(() => client.get(`/users/${id}`)),
...
export const categoriesApi = {
  list: (params) => apiRequest(() => client.get('/categories', q(params))),
  get: (id) => apiRequest(() => client.get(`/categories/${id}`)),
...
export const productsApi = {
  list: (params) => apiRequest(() => client.get('/products', q(params))),
  get: (id) => apiRequest(() => client.get(`/products/${id}`)),
...
export const ordersApi = {
  list: (params) => apiRequest(() => client.get('/orders', q(params))),
  get: (id) => apiRequest(() => client.get(`/orders/${id}`)),
  updateStatus: (id, payload) =>
    apiRequest(() => client.put(`/orders/${id}/status`, payload)),
}

export const transactionsApi = {
  list: (params) => apiRequest(() => client.get('/transactions', q(params))),
  get: (id) => apiRequest(() => client.get(`/transactions/${id}`)),
}

export const promocodesApi = {
  list: (params) => apiRequest(() => client.get('/promocodes', q(params))),
  get: (id) => apiRequest(() => client.get(`/promocodes/${id}`)),
...
export const cmsApi = {
  list: (params) => apiRequest(() => client.get('/cms', q(params))),
  get: (id) => apiRequest(() => client.get(`/cms/${id}`)),
...
export const bannersApi = {
  list: (params) => apiRequest(() => client.get('/banners', q(params))),
  get: (id) => apiRequest(() => client.get(`/banners/${id}`)),
...
export const contactApi = {
  list: (params) => apiRequest(() => client.get('/contact', q(params))),
  get: (id) => apiRequest(() => client.get(`/contact/${id}`)),
  update: (id, payload) =>
    apiRequest(() => client.put(`/contact/${id}`, payload)),
}

export const reportsApi = {
  summary: (params) => apiRequest(() => client.get('/reports', q(params))),
}
